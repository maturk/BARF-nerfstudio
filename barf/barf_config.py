...
from barf.barf import BARFFreqModelConfig, BARFHashModelConfig
...
barf_freq_method = MethodSpecification(
    ...
    description="BARF c2f freq encoding implementation.",
)
...
barf_hash_method = MethodSpecification(
    ...
    description="BARF c2f hash encoding implementation.",
)
