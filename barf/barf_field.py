"""
Field definition for vanilla freq barf, hash grid barf, and gradient scaled hash grid barf.
"""
...
class BARFHashField(NerfactoField):
...
class BARFGradientHashField(Field):
    ...
    def __init__(
        ...
        self.mlp_base_grid = ScaledHashEncoding(
